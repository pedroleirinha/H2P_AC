...
loop:
	...
	BL validate_bit ; VALIDATES 7th BIT

	
	BNE loop		; Volta ao inicio ; BIT ESTA ON
...
validate_bit:
	MOV r1, #0x80 ; MASK - 1000 0000
	AND r2, r1, r0 ; TIRA O BIT MAIS À ESQUERDA PARA VERIFICAR O BIT 7
